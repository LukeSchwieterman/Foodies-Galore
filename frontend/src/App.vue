<template>
  <div id="app">
    <div id="nav" v-if="$store.state.token != ''">
      ...
      <router-link v-bind:to="{ name: 'restaurants' } " v-if="$store.state.token != ''">Dummy Restaurants Page</router-link>&nbsp;| &nbsp;
      <router-link v-bind:to="{ name: 'details' }" v-if="$store.state.token != ''">Details</router-link>&nbsp;| &nbsp;
